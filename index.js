...
const token = '6117283616:AAENUdpIl2ITPDCa_YLUckHgqPomunVGiRc';
const webAppUrl = 'https://radiant-biscuit-f95fbf.netlify.app'
...
bot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await bot.sendMessage(chatId, 'Ниже появилась кнопка, заполни форму',{
            reply_markup:{
                keyboard:[
